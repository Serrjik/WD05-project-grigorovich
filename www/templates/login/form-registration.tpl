<form class="registration-form">
	...
	<div class="registration-form__email"><input class="input-text" type="text" placeholder="E-mail" /></div>
	<div class="registration-form__password"><input class="input-text" type="text" placeholder="Пароль" /></div>
	<div class="registration-form__button"><input class="button button-enter" type="submit" value="Регистрация" name="name" /></div>
</form>