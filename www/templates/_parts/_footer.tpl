		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="footer__social-icons">
					...
					<a href="https://www.youtube.com/channel/UCoDKBgsqe4Dzlic5CaPpZ6A" target="_blank"><i class="fab fa-youtube"></i></a>
					<a href="https://www.instagram.com/sarrgik/" target="_blank"><i class="fab fa-instagram"></i></a>
				</div>
			</div>
		</div>
	</div>
